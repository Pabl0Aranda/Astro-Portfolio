...
Hoy en día es imposible navegar por internet sin toparse con el término "Inteligencia Artificial" (IA). Sin embargo, a menudo vemos que términos como IA, _Machine Learning_ (ML) y _Deep Learning_ (DL) se utilizan como si fueran sinónimos, lo cual genera un confuso entendimiento sobre sus diferencias.
...
La gran revolución del DL es que **elimina casi por completo la necesidad del _Feature Engineering_**.
...
| **Intervención Humana** | Alta. Requiere estructurar los datos e indicar las características clave (_Feature Engineering_). | Baja. Extrae las características automáticamente a partir de datos en crudo (imágenes, audio, texto).                     |
| **Explicabilidad**      | Alta. Puedes trazar matemáticamente por qué el algoritmo tomó una decisión.                       | Baja. Es una "Caja Negra" (_Black Box_). A veces ni los ingenieros saben exactamente por qué la red tomó cierta decisión. |
...
🔗 **[IBM - ¿Qué es el Machine Learning?](https://www.ibm.com/es-es/topics/machine-learning)**

🔗 **[Coursera - Machine Learning vs Deep Learning](https://www.coursera.org/articles/machine-learning-vs-deep-learning)**
