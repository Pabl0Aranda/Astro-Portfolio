...
- **Gestión de Contenido (CMS):** Uso de _Astro Content Collections_ y esquemas de validación estrictos (Zod) para administrar el portafolio de proyectos y los artículos del blog usando archivos Markdown (`.md`).
